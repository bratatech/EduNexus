...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "EduNexuZ — tutoring for math, sciences, languages, computer science and test prep. Vetted tutors, matched in 24h." },
      { name: "author", content: "EduNexuZ" },
