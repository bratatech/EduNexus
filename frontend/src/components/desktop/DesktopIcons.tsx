import { FileText, Folder, Users, Send, Globe, Code2, TerminalSquare, Settings as SettingsIcon, BookOpen, GraduationCap, MessageCircle, UserCircle } from "lucide-react";
